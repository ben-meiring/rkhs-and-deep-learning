...
For large $\lambda$, both solutions approach the linear least-squares fit. As $\lambda\to0$, the neural network becomes unregularized, and the objective no longer selects a preferred interpolant according to its roughness.
